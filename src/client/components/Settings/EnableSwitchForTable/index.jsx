...
class EnableSwitchForTable extends React.Component {
  labelRef = createRef()
  ...
  render () {
    ...
    return (
      <div className='md-switch-wrapper md-switch md-green uk-clearfix' style={combinedStyle}>
...
EnableSwitchForTable.propTypes = {
...
export default EnableSwitchForTable